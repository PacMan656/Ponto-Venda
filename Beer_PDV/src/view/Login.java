...
// A instância do modelo de dados para login
    private login lg = new login();
    // A instância do DAO para operações de login
    private LoginDAO loginDAO = new LoginDAO();

    public Login() {
        initComponents();
        setLocationRelativeTo(null); // Centraliza a janela
        // Configura os valores padrão para os campos de email e senha
        txtUsuario.setText("marcosfelipe.sirgueira@gmail.com");
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Iniciar Sistema", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 280, 380));
